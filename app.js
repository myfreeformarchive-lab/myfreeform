...
function createPostNode(item) {
  ...
  el.className = `feed-item block w-full bg-white px-4 py-3 mb-4 pb-6 border-b border-slate-100 lg:border-b-[2px] lg:border-x-slate-500 relative transition-colors ${cursorClass}`;
