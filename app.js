...
function showToast(message, type = "success") {
  ...
  // Styling: Sleek, thin, and centered
  toast.className = `toast-enter pointer-events-auto flex items-center gap-3 px-5 py-2.5 rounded-full shadow-lg ${colors[type] || colors.success} text-white text-[13px] font-semibold mb-3 border border-white/10`;
